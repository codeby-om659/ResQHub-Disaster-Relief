...
*    **1.3-layered SOS Resilience:**
  ...
  3. ** layer 3 (Bluetooth Mesh Networking):** Peer-to-peer (Hop by-Hop) data transfer using Web Bluetooth when mobile towwers completely collapse.
*    **Smart Priority Scoring Algorithm(1 to 10):** Automatically prioritizes critical cases (Medical & Trapped cases) to the top of the queue for the rescue contrl romm.
