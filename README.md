...
2.    **Smart Priority Scoring Algorithm(1 to 10):** Automatically prioritizes critical cases (Medical & Trapped cases) to the top of the queue for the rescue contrl
 room. 
3.    **Donor Transparency Portal:** Real-time supply Tracking with Gps and photo proof-of-delieveery for donors.
